...
}// when guess is too highelse if ( guess> secretNumber) {    if (score >1)  {
...
//when the guess is to lowelse if ( guess < secretNumber) {    document.querySelector('.message').textContent = ' To low ';   score--;    document.querySelector('.score').textContent = score;
}
